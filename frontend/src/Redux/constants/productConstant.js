...
export const ALL_REVIEW_REQUEST = "ALL_REVIEWS_REQUEST";
export const ALL_REVIEW_SUCCESS = "ALL_REVIEWS_SUCCESS";
export const ALL_REVIEW_RESET = "ALL_REVIEWS_RESET";
export const ALL_REVIEW_FAIL = "ALL_REVIEWS_FAIL";
